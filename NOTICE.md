...
`eval-class_eval` packages an evaluation from **inspect_evals**.

- **Upstream:** https://github.com/UKGovernmentBEIS/inspect_evals (`src/inspect_evals/class_eval`)
...
- `huggingface`: `FudanSELab/ClassEval`
