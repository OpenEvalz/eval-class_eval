#!/usr/bin/env python3
"""Run ONE problem of class_eval through TrustedRouter and emit a reproducibility bundle.
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one class_eval problem via TrustedRouter")
