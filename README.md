...
hours. The study shows that LLMs perform worse on class-level tasks compared to method-level
tasks.
...
| | |
|---|---|
| Upstream | [`src/inspect_evals/class_eval`](https://github.com/UKGovernmentBEIS/inspect_evals/tree/main/src/inspect_evals/class_eval) |
| Group | Coding |
| Total samples | 100 |
...
- `huggingface` — `FudanSELab/ClassEval` (pinned)
